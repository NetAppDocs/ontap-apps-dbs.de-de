...
Das Kopieren einer 10-TB-Datenbank dauert beispielsweise in der Regel etwa sieben Stunden. Wenn die Geschäftsanforderungen eine siebenstündige Ausfallzeit zulassen, ist das Kopieren von Dateien eine einfache und sichere Option für die Migration. Sind fünf Stunden nicht akzeptabel, kann mit minimalem Aufwand ein einfacher Log-Shipping-Prozess (siehe link:oracle-migration-log-shipping.html["Oracle-Protokollversand"]) eingerichtet werden, um die Umstellungszeit auf etwa 15 Minuten zu reduzieren. Während dieser Zeit kann ein Datenbankadministrator den Prozess abschließen. Sind auch 15 Minuten nicht akzeptabel, lässt sich der finale Umstellungsprozess durch Skripting automatisieren, sodass die Umstellungszeit auf nur wenige Minuten reduziert werden kann. Eine Migration kann zwar immer beschleunigt werden, dies ist jedoch mit einem höheren Zeit- und Arbeitsaufwand verbunden. Die Zielvorgaben für die Umstellungszeit sollten sich daran orientieren, was für das Unternehmen akzeptabel ist.
