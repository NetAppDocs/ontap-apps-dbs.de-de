...
summary: LVM-Stripe-Konfiguration für Oracle-Datenbanken mit ASA r2 
searchtitle: LVM-Striping mit Oracle-Datenbanken auf ASA r2 
---
= LVM-Striping
:hardbreaks:
:allow-uri-read: 
...
* Stripe-Größe ≥ Datenbank-Blockgröße.
* Stripe-Größe * Anzahl der LUNs ≈ 1 MB für optimale Parallelität.
