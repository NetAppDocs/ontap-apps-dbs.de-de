...
Die NFS-Performance unter Linux hängt von einem Parameter namens ab `tcp_max_slot_table_entries`. Siehe link:../../common/storage-configuration/nfs.html["NFS"] Für kritische Informationen.
