...
[NOTE]
====
* Bei Oracle Datenbanken sollte NVFAIL auf allen LUNs aktiviert werden, die kritische Komponenten (Datafiles, Wiederherstellungsprotokolle, Control Files) hosten.
* Auf AFF-Systemen arbeitet NVFAIL auf der Volume-Ebene und gilt für alle darin enthaltenen Daten.
* Auf ASA arbeitet NVFAIL auf der LUN- oder Namespace-Ebene.
