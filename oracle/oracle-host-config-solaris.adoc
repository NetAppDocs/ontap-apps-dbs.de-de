...
. Partitionieren Sie die LUNs und überprüfen Sie deren korrekte Ausrichtung. Siehe link:oracle-notes-wafl-alignment-verification.html["WAFL Ausrichtung"] für Anweisungen zum direkten Testen und Bestätigen der Ausrichtung.
