...
[role="lead"]
Der Hauptnutzen von ONTAP in einer Oracle Datenbankumgebung ergibt sich aus den Kerntechnologien von ONTAP, wie z. B. sofortigen Snapshot-Kopien, einfacher SnapMirror-Replikation und effizienter Erstellung geklonter Volumes, LUNs und Namespaces.
