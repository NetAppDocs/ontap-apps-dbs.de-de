...
[role="lead"]
Eine SQL Server-Datenbank ist eine Sammlung von Objekten, mit denen Sie Daten speichern und bearbeiten können.
...
image:./media/filegroups.png["Fehler: Fehlendes Grafikbild"]
...
image:./media/security-policy.png["Fehler: Fehlendes Grafikbild"]
...
image:./media/zeroing.png["Fehler: Fehlendes Grafikbild"]
...
image:./media/maintenance.png["Fehler: Fehlendes Grafikbild"]
