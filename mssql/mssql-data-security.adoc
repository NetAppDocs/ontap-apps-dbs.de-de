...
---
= Sichern von Microsoft SQL Server auf ONTAP
:allow-uri-read: 
:imagesdir: ../media/


[role="lead"]
Die Sicherung einer SQL Server-Datenbankumgebung ist ein mehrdimensionaler Aufwand, der über das Management der Datenbank selbst hinausgeht. ONTAP bietet verschiedene einzigartige Funktionen, die den Storage-Aspekt Ihrer Datenbankinfrastruktur sichern sollen.
