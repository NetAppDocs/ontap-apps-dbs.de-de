...
NOTE: vVols erfordert die Verwendung von ONTAP tools for VMware vSphere, das als VASA Provider für ONTAP fungiert. Siehe link:vmware-vvols-overview.html["VMware vSphere Virtual Volumes (VVols) mit ONTAP"] für vVols Best Practices.
