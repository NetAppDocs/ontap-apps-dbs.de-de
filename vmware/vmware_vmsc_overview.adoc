...
Weitere Informationen über die Vorteile von symmetrischem oder asymmetrischem Design und Einsatz finden Sie im https://docs.netapp.com/us-en/ontap/smbc/index.html["SnapMirror Active Sync Dokumentation"].
