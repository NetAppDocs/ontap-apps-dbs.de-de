...
Wie oben erwähnt, kann die Verwendung von Richtlinien zur Vereinfachung der Bereitstellung von Volumes beitragen. Wählen Sie einfach eine entsprechende Richtlinie aus. VASA Provider zeigt VVols Datastores, die diese Richtlinie unterstützen, und platziert das vVol in einer individuellen, konformen FlexVol volume.
