...
Die neuesten Informationen zu SnapMirror und SnapVault für ONTAP 9 finden Sie hier: https://www.netapp.com/pdf.html?item=/media/17229-tr-4015-snapmirror-configuration-ontap.pdf["TR-4015 SnapMirror Configuration Best Practice Guide für ONTAP 9."^]
