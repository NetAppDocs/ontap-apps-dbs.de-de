...
Die folgenden Premium-Softwareprodukte sind von NetApp erhältlich. Sie sind nicht in der ONTAP One-Lizenz enthalten und müssen separat erworben werden. * https://www.netapp.com/data-services/disaster-recovery/["NetApp Disaster Recovery (DR)"] für VMware vSphere. Dies ist ein Cloud-basierter Dienst, der Notfallwiederherstellung und Backup für VMware-Umgebungen bereitstellt. Es kann mit oder ohne SnapCenter verwendet werden und unterstützt On-Prem-zu-On-Prem-DR mithilfe von SAN oder NAS sowie On-Prem-zu/von der Cloud mithilfe von NFS, sofern unterstützt. * https://www.netapp.com/data-infrastructure-insights/["Einblicke in die Dateninfrastruktur (DII)"]. Dies ist ein Cloud-basierter Dienst, der Überwachung und Analyse für VMware-Umgebungen bereitstellt. Es unterstützt andere Speicheranbieter in heterogenen Speicherumgebungen sowie mehrere Switch-Anbieter und andere Hypervisoren. DII bietet umfassende End-to-End-Einblicke in die Leistung, Kapazität und Integrität Ihrer VMware-Umgebung.
